...
📊 [Визуализации](./product_analitics_portfolio/telecom/visuals/)  
📝 [Выводы и рекомендации](./product_analitics_portfolio/telecom/insights)
...
#### 📦 Nordwind (Когортный и RFM анализ):
...
Другие боты:  
"Бот-читалка" имититация чтения электронной книги [тут](https://github.com/MargoUtropova/book_reading_bot). Бот-игра "Камень-ножницы-бумага" [тут](https://github.com/MargoUtropova/paper_stone_bot).
